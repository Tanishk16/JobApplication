...
<head>
	...
	<title>Tanishk Job Portal</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
	<div class="container">
		<a class="navbar-brand fs-1 fw-medium" href="#">Tanishk Job Portal Web App</a>
		<button class="navbar-toggler" type="button" data-s-toggle="collapse" data-bs-target="#navbarNav"
